...
public class ThermNetworkingPackets {
	...
	public static final Identifier PLAYER_TEMP_TICK_C2S_PACKET_ID = new Identifier(ThermMod.modid,
			"player_temp_tick_c2s_packet");
	public static final Identifier DRINK_ICE_WATER_C2S_PACKET_ID = new Identifier(ThermMod.modid,
			"drink_ice_water_c2s_packet");

	// Server to Client

	public static final Identifier SEND_THERMPLAYERSTATE_S2C_PACKET_ID = new Identifier(ThermMod.modid,
			"send_thermplayerstate_s2c_packet");
	...
	public static void registerS2CPackets() {
		ClientPlayNetworking.registerGlobalReceiver(SEND_THERMPLAYERSTATE_S2C_PACKET_ID,
				(client, handler, buf, responseSender) -> {
					...
					client.execute(() -> {
						...
						ThermClient.clientStoredWindTemperature = windTemp;
					});
				});
	}
}