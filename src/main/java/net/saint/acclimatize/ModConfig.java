...
public class ModConfig implements ConfigData {
	...
	@ConfigEntry.Category("player") @Comment("Second threshold for hypothermia, being below this you will freeze faster. (Default: 20.0)")
	...
	@ConfigEntry.Category("player") @Comment("Second threshold for hyperthermia, being above this you will burn faster (Default: 75.0)")
	...
	@ConfigEntry.Category("world") @Comment("Base temperature for frigid climates. (Default: 15.0)")
	public double frigidClimateTemperature = 15.0;

	@ConfigEntry.Category("world") @Comment("Base temperature for cold climates. (Default: 30.0)")
	public double coldClimateTemperature = 30.0;

	@ConfigEntry.Category("world") @Comment("Base temperature for temperate climates. (Default: 50.0)")
	public double temperateClimateTemperature = 50.0;

	@ConfigEntry.Category("world") @Comment("Base temperature for hot climates. (Default: 55.0)")
	public double hotClimateTemperature = 55.0;

	@ConfigEntry.Category("world") @Comment("Base temperature for arid climates. (Default: 70.0)")
	...
	@ConfigEntry.Category("blocks") @Comment("Temperature value applied when the player is submerged in water. (Default: -8.0)")
	public double waterBlockTemperature = -8.0;

	// Items

	@ConfigEntry.Category("items") @Comment("Multiplier for how much each level of fire protection cools you (Default: -1.0)")
	public double fireProtectionCoolingFactor = -1.0;

	@ConfigEntry.Category("items") @Comment("Multiplier for how much each level of cold protection warms you (Default: 1.0)")
	...
	@ConfigEntry.Category("wind") @Comment("The base number of ticks until wind intensity is updated, plus randomization. (Default: 1200)")
	...
	@ConfigEntry.Category("wind") @Comment("How many blocks long wind rays are. Increase for larger spaces. (Default: 16)")
