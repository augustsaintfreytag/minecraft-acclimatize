...
public final class ServerStateNBTKeys {

	public static final String worldVersion = "worldVersion";

	public static final String players = "players";

	public static final String season = "season";
	public static final String seasonTick = "seasonTick";
	...
	public static final String windPitch = "windPitch";
	public static final String windYaw = "windYaw";
